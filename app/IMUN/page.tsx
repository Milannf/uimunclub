    ...
    return(
      ...
      <div className="relative h-screen flex flex-col items-center justify-center">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            >
              “The oldest and most prestigious Model UN <br /> conference in Indonesia”
            </h1>
